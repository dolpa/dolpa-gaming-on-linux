...
GANME_EXE_PATH=""                           # Relative path to the game executable from the game root folder (used to locate the executable for launching)
...
GAME_LAUNCH_ARGS="--launcher-skip --intro-skip -benchmark"
