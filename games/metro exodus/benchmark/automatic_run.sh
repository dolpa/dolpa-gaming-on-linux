...
export GAME_ID="1449560"
export PROTON_BIN="/mnt/Data/Games/Steam/steamapps/common/Proton - Experimental/proton"
export GAME_EXE="/mnt/Data/Games/Steam/steamapps/common/Metro Exodus Enhanced Edition/Benchmark.exe"
export GAME_DIR="/mnt/Data/Games/Steam/steamapps/common/Metro Exodus Enhanced Edition"
...
auto_select_preset_and_run_all() {
	...
	for _ in $(seq 1 "$attempts"); do
		win_id="$(xdotool search --name "METRO EXODUS ENHANCED Benchmark" 2>/dev/null | head -n1 || true)"
		if [[ -n "$win_id" ]]; then
			local width height
